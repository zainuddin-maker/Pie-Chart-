TW.Runtime.Widgets.Widgetpiechart = function () {
    ...
    this.setupWidget = function () {
        ...
        try {
            ...
            console.log("widgetProps rungging pie");
        ...
        // var width = widgetProps.Widthpie;
        // height = widgetProps.Heightpie;
        // rsize = widgetProps.Radiuspie;
        // borderpie =widgetProps.Styleborder.lineColor;
        ...
        svg.selectAll("whatever")
            ...
            .on("mousemove", function (d) {
                d3v4.select("#tooltippie")
                    .style("left", d3v4.event.offsetX + "px")
                    .style("top", d3v4.event.offsetX + "px")
                    .style("opacity", 1)
                    .style("display", "block")
                    .select("#name")
                    .text(d.data.key);
